...
[
    ...
    },
    {
        ...
        "f_es7": "var sbfm = 0.175 * bounces + 0.0875 - power/4;\nvar sbm = Math.Sin(2 * sbfm * Math.PI/power);\nvar max = sbm * Math.Pow(2, -10 * (0.175 * bounces + 0.0875)) + 1;\nt *= 0.175 * bounces + 0.0875;\nvar sb = Math.Sin((t - power / 4) * (2*Math.PI)/power);\nreturn (sb * Math.Pow(2, -10 * t) + 1)/max;",
        "f_cs":  "let sbfm = 0.175f * bounces + 0.0875f - power/4;\nlet sbm = Math.sin(2 * sbfm * Math.PI/power);\nlet max = sbm * Math.pow(2, -10 * (0.175f * bounces + 0.0875f)) + 1;\nt *= 0.175f * bounces + 0.0875;\nlet sb = Math.sin((t - power / 4) * (2*Math.PI)/power);\nreturn (sb * Math.pow(2, -10 * t) + 1)/max;",
    },
    {
    ...
    },
    {
        ...
        "f_cs":  "let s = Math.Sin(2*(2*t-1-p/4f)*Math.PI/p)/2;\nreturn s*Math.Pow(2,(t<0.5f?10:-10)*(2*t-1))*(t<0.5f?-1:1)+(t<0.5f?0:1)",
    },
    {
